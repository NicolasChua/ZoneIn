/**
 * @description
 * This file contains the domain model for Chicago's zoning information.
 * It provides a structured object representing the city's zoning districts, subdistricts,
 * and specific zone parameters. This data is used as a tool/knowledge base for the AI model.
 *
 * @exports chicagoZoningData - A comprehensive object containing all zoning rules.
 */

export const chicagoZoningData = {
  "districts": {
    "Residential": {
      "subdistricts": {
        "RS": {
    ...
    "Parks and Open Space": {
      "subdistricts": {
        "POS-1": {
          ...
          "front_yard_setback": "None, unless property borders R-zoned lot that faces the same street. Then, front setback must be at least 50% of the R lot's front setback.",
